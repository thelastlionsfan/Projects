...
/****** Object:  Database [DVDLibrary]    Script Date: 11/3/2015 9:45:15 AM ******/
...
/****** Object:  Table [dbo].[DVDInfo]    Script Date: 11/3/2015 9:46:14 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[DVDInfo]  WITH CHECK ADD  CONSTRAINT [FK_DVDInfo_BorrowerInfo] FOREIGN KEY([BorrowerID])
REFERENCES [dbo].[BorrowerInfo] ([BorrowerID])
GO

ALTER TABLE [dbo].[DVDInfo] CHECK CONSTRAINT [FK_DVDInfo_BorrowerInfo]
GO
USE [DVDLibrary]
GO

/****** Object:  Table [dbo].[BorrowerInfo]    Script Date: 11/3/2015 9:48:07 AM ******/
SET ANSI_NULLS ON
GO
